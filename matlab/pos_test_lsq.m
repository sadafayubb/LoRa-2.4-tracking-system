...
function pos_test_lsq()
    ...
    % Print results
    fprintf('\n=== LSQ Trilateration (No Calibration) ===\n');
    for i = 1:nTests
    ...
    title('LSQ Trilateration - No Calibration');
    grid on; axis equal;
    ...
    % Save figure
    output_file = fullfile(figures_dir, 'pos_lsq.jpg');
