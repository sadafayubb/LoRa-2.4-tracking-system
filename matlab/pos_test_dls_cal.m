...
function pos_test_dls_cal()
    ...
    % Print results
    fprintf('\n=== DLS Trilateration WITH Calibration ===\n');
    for i = 1:nTests
    ...
    title('DLS Trilateration - With Calibration');
    grid on; axis equal;
    ...
    % Save figure
    output_file = fullfile(figures_dir, 'pos_dls_calibrated.jpg');
